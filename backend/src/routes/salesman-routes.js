...
router.get("/",
    ...
    checkAuthorization([0]), SalesManController.getAllSalesmen)
...
router.get("/:code",
    ...
    // #swagger.tags = ['Salesmen']
    checkAuthorization([0]), SalesManController.getSalesmanByCode)
...
router.post("/calculate-bonuses",
    ...
    // #swagger.tags = ['Salesmen']
    checkAuthorization([0]), SalesManController.calculateAllBonuses)
router.post("/send-bonuses-orangeHRM",
    ...
    // #swagger.tags = ['Salesmen']
    checkAuthorization([0]), SalesManController.sendAllBonusesToHRM)
...
schema: { $ref: '#/definitions/socialPerformanceRecordSchema' }
    ...
    checkAuthorization([0]), SalesManController.createSocialPerformanceToSalesmanBySalesmanCode)
